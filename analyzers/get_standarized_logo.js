...
import { getPromptStandarizedLogo} from '../modules/prompt_generator.js';
 ...
 */
export async function getStandarizedLogo(postData) {

    let logo = await getAiImage(postData);
...
async function getAiImage(data) {
    ...
    let prompt = getPromptStandarizedLogo(data);
